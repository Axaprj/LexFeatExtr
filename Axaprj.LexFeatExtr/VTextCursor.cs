...
namespace Axaprj.LexFeatExtr
{
    /// <summary>
    /// Cursor with start-stop tokens range.
    /// </summary>
    public class VTextCursor : ITextCursor
    {
        ...
        public VTextCursor(string inputText, IRequestContext context, char tokenSeparator = ' ')
        {
